...
class NotFeedProcessor(BaseProcessor):
    ...
    def __is_not_liked_acc_post(self):
        ...
        self.heart = None
        try:
            is_not_liked_span = self.browser.find_element_by_css_selector(
                ".coreSpriteHeartOpen").find_element_by_css_selector(
                '.glyphsSpriteHeart__outline__24__grey_9').find_element_by_xpath('..')
