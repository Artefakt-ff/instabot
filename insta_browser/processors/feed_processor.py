    ...
    def process(self, exclude, login):
        ...
        for post in progress:
            ...
            if filtered_posts.__len__():
                ...
                heart = real_post.find_element_by_css_selector(
                    'div:nth-child(3) section span:first-child').find_element_by_css_selector(
                    ".coreSpriteHeartOpen")
                ...
                # check restrictions
                try:
                    heart.find_element_by_css_selector('.glyphsSpriteHeart__outline__24__grey_9')
                    heart = heart.find_element_by_xpath('..')
                    is_not_liked = True
                except excp.NoSuchElementException:
                    is_not_liked = False
